...
public class Question {
	...
	public static int updateBits(int n, int m, int i, int j) {
		...
		System.out.println("N : [" + AssortedMethods.toFullBinaryString(n) + "] Mask [" + AssortedMethods.toFullBinaryString(mask) +"]");
		/* Clear i through j, then put m in there */
		int n_cleared = n & mask; // Clear bits j through i.
		int m_shifted = m << i; // Move m into correct position.
	
		System.out.println("N Cleared: [" + AssortedMethods.toFullBinaryString(n_cleared) + "] m_shifted [" + AssortedMethods.toFullBinaryString(m_shifted) +"]");
